...
export const routes: Routes = [
  ...
  // SUBSCRIPTION (trial expire pe yahan bhejo)
  {
    path: 'subscribe',
  ...
  // ADMIN
  {
    ...
    children: [
      { path: '', redirectTo: 'dashboard', pathMatch: 'full' },
      {
        path: 'dashboard',
        loadComponent: () =>
          import('./features/admin/dashboard/admin-dashboard.component').then(c => c.AdminDashboardComponent)
      },
      {
        path: 'shops',
        loadComponent: () =>
          import('./features/admin/shops/shops.component').then(c => c.ShopsComponent)
      },
      {
        path: 'subscriptions',
        loadComponent: () =>
          import('./features/admin/subscriptions/subscriptions.component').then(c => c.SubscriptionsComponent)
      },
      {
        path: 'notifications',
        loadComponent: () =>
          import('./features/admin/notifications/notifications.component').then(c => c.NotificationsComponent)
      },
      // {
      //   path: 'payments',
      //   loadComponent: () =>
      //     import('./features/admin/payments/payment-approvals').then(c => c.PaymentApprovalsComponent)
      // },
    ]
  },
