...
public partial class AgroBillingDbContext : DbContext
{
    ...
    {
        // Runtime config comes from Program.cs — do not configure here
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<AdminNotification>(entity =>
        {
            ...
            entity.HasOne(d => d.Shop).WithMany(p => p.AdminNotifications)
                .HasForeignKey(d => d.ShopId).OnDelete(DeleteBehavior.ClientSetNull);
        });

        modelBuilder.Entity<AdminUser>(entity =>
        {
            entity.HasKey(e => e.AdminId);
            // ✅ No SQL Server name — PostgreSQL generates its own constraint name
        ...
        modelBuilder.Entity<Bill>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.ShopId, e.BillDate, e.PaymentStatus }, "IX_Bills_ShopID_Date_Status")
                ...
                .IncludeProperties(e => new { e.CustomerId, e.TotalAmount, e.AmountPaid, e.AmountPending, e.BillNumber });

            entity.HasIndex(e => new { e.ShopId, e.CustomerId }, "IX_Bills_ShopID_CustomerID");

            // ✅ No SQL Server name — PostgreSQL generates its own constraint name
            entity.HasIndex(e => new { e.ShopId, e.BillNumber }).IsUnique();
            ...
            entity.Property(e => e.Gstamount).HasColumnType("numeric(10, 2)").HasColumnName("GSTAmount");
            entity.Property(e => e.Gstpercent).HasColumnType("numeric(5, 2)").HasColumnName("GSTPercent");
        ...
        modelBuilder.Entity<BillPayment>(entity =>
        {
            ...
            entity.Property(e => e.PaymentMode).IsRequired().HasMaxLength(50).HasDefaultValue("Cash");
        ...
        modelBuilder.Entity<CreditNote>(entity =>
        {
            ...
            entity.HasOne(d => d.OriginalBill).WithMany(p => p.CreditNotes)
                .HasForeignKey(d => d.OriginalBillId).OnDelete(DeleteBehavior.ClientSetNull);
        ...
        modelBuilder.Entity<CreditNoteItem>(entity =>
        {
            ...
            entity.HasOne(d => d.CreditNote).WithMany(p => p.CreditNoteItems)
                .HasForeignKey(d => d.CreditNoteId).OnDelete(DeleteBehavior.ClientSetNull);
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.Property(e => e.ShopId).HasColumnName("ShopID");
            entity.Property(e => e.State).IsRequired().HasMaxLength(100).HasDefaultValue("Haryana");
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.Property(e => e.IsActive).HasDefaultValue(true);
            entity.Property(e => e.MinStockAlert).HasDefaultValue(5.000m).HasColumnType("numeric(12, 3)");
            entity.Property(e => e.ProductName).IsRequired().HasMaxLength(200);
            ...
            entity.Property(e => e.UseShopGst).HasDefaultValue(true).HasColumnName("UseShopGST");
        ...
        modelBuilder.Entity<PurchaseOrder>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.ShopId, e.PurchaseDate }, "IX_PurchaseOrders_ShopID_Date")
                .IsDescending(false, true)
                .IncludeProperties(e => new { e.SupplierId, e.NetPayable, e.AmountPaid, e.PaymentStatus });
            ...
            entity.HasOne(d => d.Supplier).WithMany(p => p.PurchaseOrders)
                .HasForeignKey(d => d.SupplierId).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<PurchaseOrderItem>(entity =>
        {
            ...
            entity.HasOne(d => d.Purchase).WithMany(p => p.PurchaseOrderItems)
                .HasForeignKey(d => d.PurchaseId).OnDelete(DeleteBehavior.ClientSetNull);
        });
        ...
        modelBuilder.Entity<Shop>(entity =>
        {
            ...
            entity.Property(e => e.Gstnumber).HasMaxLength(20).HasColumnName("GSTNumber");
            entity.Property(e => e.Gstpercent).HasDefaultValue(18.00m).HasColumnType("numeric(5, 2)").HasColumnName("GSTPercent");
            entity.Property(e => e.IsActive).HasDefaultValue(true);
        ...
        modelBuilder.Entity<StockMovement>(entity =>
        {
            ...
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("NOW()");
            entity.Property(e => e.MovementType).IsRequired().HasMaxLength(30);
            entity.Property(e => e.Notes).HasMaxLength(200);
            entity.Property(e => e.ProductId).HasColumnName("ProductID");
        ...
        {
            entity.HasNoKey().ToView("vw_CustomerPendingSummary");
            entity.Property(e => e.CustomerId).HasColumnName("CustomerID");
            entity.Property(e => e.FullName).IsRequired().HasMaxLength(100);
            entity.Property(e => e.MobileNumber).IsRequired().HasMaxLength(15);
            entity.Property(e => e.ShopId).HasColumnName("ShopID");
        ...
        {
            entity.HasNoKey().ToView("vw_SupplierOutstanding");
            entity.Property(e => e.CompanyName).IsRequired().HasMaxLength(150);
            entity.Property(e => e.OpeningBalance).HasColumnType("numeric(12, 2)");
        ...
        modelBuilder.Entity<PaymentRequest>(entity =>
        {
            ...
            entity.Property(e => e.PayerName).IsRequired().HasMaxLength(100);
